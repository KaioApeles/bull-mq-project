...
exports.parentSend = exports.childSend = exports.asyncSend = exports.isNotConnectionError = exports.DELAY_TIME_1 = exports.DELAY_TIME_5 = exports.clientCommandMessageReg = exports.jobIdForGroup = exports.getParentKey = exports.removeAllQueueData = exports.isRedisInstance = exports.delay = exports.array2obj = exports.isEmpty = exports.lengthInUtf8Bytes = exports.tryCatch = exports.errorObject = void 0;
...
function jobIdForGroup(jobOpts, data, queueOpts) {
    ...
    const groupKeyPath = lodash_1.get(queueOpts, 'limiter.groupKey');
    const groupKey = lodash_1.get(data, groupKeyPath);
    if (groupKeyPath && !(typeof groupKey === 'undefined')) {
        return `${jobId || uuid_1.v4()}:${groupKey}`;
    }
    return jobId;
}
...
exports.parentSend = (child, msg) => exports.asyncSend(child, msg);
